...
<head>
    ...
    <title>Formulir Donor.</title>
    <link href='https://fonts.googleapis.com/css?family=Alata' rel='stylesheet'>
    <link rel="stylesheet" href="formulirdarah.css">
</head>
    <div class="wrapper">
        <!-- untuk home -->
        <form action="create_pendonor.php" method="post">
            <section id="home">
                <img class="image1" src="assets/img/Rectangle 4.png" alt=""/>
                <div class="kolom">
                    <p class="deskripsi">Formulir Donor Darah</p>
                    <h2>Nama</h2>
